...
print("neural network evaluation: ", results(metrics.confusion_matrix(lasso_y_test, pred)))
...
np.set_printoptions()
print("SVM evaluation for lasso: ",results(metrics.confusion_matrix(lasso_y_test, pred_lasso_svm)))
...
print("random forest evaluation results for lasso:",results(metrics.confusion_matrix(lasso_y_test, lasso_rf_pred)))
